...
<head>
    ...
    <link rel="stylesheet" href="../css/granada.css">
...
<body>
    ...
    <div class="back">
        <img src="../imagen/granada/back.jpg" alt="">
        <div class="titulo">
            <p>Granada</p>
        </div>
    </div>
        ...
        <div class="horarios">
            <div class="padre">
                ...
                <div class="left">
                    ...
                    <div class="left-text"><p><b>DESTINO: </b> Granada (Saint George's)</p></div>
                </div>
            </div>
...
<div class="img">
    <img src="../imagen/granada/granada.jpg" alt="">
</div>
    </div>
    <!--pie de pagina web-->
    <footer>
