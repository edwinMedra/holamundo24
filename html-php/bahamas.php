...
<head>
    ...
    <link rel="stylesheet" href="../css/bahamas.css">
...
?> 
    <!--Fin header-->   
     ...
     <div class="back">
        <div><img src="../imagen/bahamas/back.jpg" alt=""></div>
        <div class="titulo text-white">BAHAMAS</div>
    </div>
    ...
    <div class="container rounded-4 border border-1 border-black w-100 p-0 my-5">
        <div class="row">
            <div class="col-8 mt-4">
                <div class="row d-flex mx-auto my-4 w-75 border border-black border-1 rounded-5">
                    ...
                    <div class="col d-flex border border-top-0 border-end-0 border-bottom-0 border-black" id="origen">
                        ...
                        <x class="mt-3"> <b>DESTINO:</b> Nesáu (Bahamas)</x>
                    </div>
                </div>
                <!---->
                <div class="row d-flex mx-auto my-4 w-75 border border-black border-1 rounded-5">
            ...
            <!---->
            <div class="col-4">
                <img src="../imagen/bahamas/nesau.jpg" alt="" class="w-100 rounded-4 pe-0">
            </div>
        </div>
    </div>
</body>
