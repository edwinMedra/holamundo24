...
<head>
    ...
    <link rel="stylesheet" href="../css/honduras.css">
...
?> 
    ...
    <div class="back">
        <img src="../imagen/honduras/back.jpg" alt="">
        <div class="titulo">
            <p>Honduras</p>
        </div>
    </div>
        ...
        <div class="horarios">
            <div class="padre">
                ...
                <div class="left">
                    ...
                    <div class="left-text"><p><b>DESTINO: </b> Honduras (Roatán)</p></div>
                </div>
            </div>
...
<div class="img">
    <img src="../imagen/honduras/Roatán.jpg" alt="">
</div>
    </div>
<!--Fin Roatán-->
<!--san Tegucigalpa-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Honduras (Tegucigalpa)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/honduras/Tegucigalpa.jpeg" alt="">
</div>
</div>
<!--Fin  Tegucigalpa-->
<!-- La Ceiba:-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Honduras (La Ceiba)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/honduras/La Ceiba.jpg" alt="">
</div>
</div>
<!--Fin la ceiba-->
    <!--pie de pagina web-->
