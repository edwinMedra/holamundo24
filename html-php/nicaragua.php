...
<head>
    ...
    <link rel="stylesheet" href="../css/nicaragua.css">
...
<body>
    ...
    <div class="back">
        <img src="../imagen/nicaragua/back.jpg" alt="">
        <div class="titulo">
            <p>Nicaragua</p>
        </div>
    </div>
        ...
        <div class="horarios">
            <div class="padre">
                ...
                <div class="left">
                    ...
                    <div class="left-text"><p><b>DESTINO: </b> Nicaragua (Managua)</p></div>
                </div>
            </div>
...
<div class="img">
    <img src="../imagen/nicaragua/Managua.webp" alt="">
</div>
    </div>
<!--Fin Managua-->
<!--Liberia-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Nicaragua (Liberia)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/nicaragua/Liberia.jpg" alt="">
</div>
</div>
<!--Fin Liberia-->
<!--Bluefields-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Nicaragua (Bluefields)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/nicaragua/Bluefields.jpg" alt="">
</div>
</div>
<!--Fin Bluefields-->
    <!--pie de pagina web-->
