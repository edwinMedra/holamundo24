...
<head>
    ...
    <link rel="stylesheet" href="../css/guayana.css">
...
<body>
    ...
    <div class="back">
        <img src="../imagen/guayana/back.jpg" alt="">
        <div class="titulo">
            <p>Guayana</p>
        </div>
    </div>
        ...
        <div class="horarios">
            <div class="padre">
                ...
                <div class="left">
                    ...
                    <div class="left-text"><p><b>DESTINO: </b> Guayana (Geogertown)</p></div>
                </div>
            </div>
...
<div class="img">
    <img src="../imagen/guayana/georgetown.webp" alt="">
</div>
    </div>
<!--Fin georgetow-->
<!--Matthew's Ridge-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Guayana (Matthew's Ridge)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/guayana/Matthew's Ridge.jpg" alt="">
</div>
</div>
<!--Fin  Matthew's Ridge-->
<!--Mabaruma-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Guayana (Mabaruma)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/guayana/Mabaruma.jpg" alt="">
</div>
</div>
<!--Fin Mabaruma-->
    <!--pie de pagina web-->
