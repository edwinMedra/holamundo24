...
<body>
    ...
    <div class="back">
        <img src="../imagen/venezuela/back.jpg" alt="">
        <div class="titulo">
            <p>Venezuela</p>
        </div>
    </div>
        ...
        <div class="horarios">
            <div class="padre">
                ...
                <div class="left">
                    ...
                    <div class="left-text"><p><b>DESTINO: </b> Venezuela (Caracas)</p></div>
                </div>
            </div>
...
<div class="img">
    <img src="../imagen/venezuela/caracas.jpg" alt="">
</div>
    </div>
<!--Fin caracas-->
<!--Valencia-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Venezuela (Valencia)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/venezuela/valencia.jpg" alt="">
</div>
</div>
<!--Fin  Valencia-->
<!--Acarigua-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Venezuela (Acarigua)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/venezuela/Acarigua.jpg" alt="">
</div>
</div>
<!--Fin Acarigua-->
    <!--pie de pagina web-->
