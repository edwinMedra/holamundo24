...
<head>
    ...
    <link rel="stylesheet" href="../css/jamaica.css">
...
?> 
    ...
    <div class="back">
        <img src="../imagen/jamaica/back.jpg" alt="">
        <div class="titulo">
            <p>Jamaica</p>
        </div>
    </div>
        ...
        <div class="horarios">
            <div class="padre">
                ...
                <div class="left">
                    ...
                    <div class="left-text"><p><b>DESTINO: </b> Jamaica (Montego Bay)</p></div>
                </div>
            </div>
...
<div class="img">
    <img src="../imagen/jamaica/Montego Bay.jpg" alt="">
</div>
    </div>
<!--Fin Montego Bay-->
<!--san Kingston-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Jamaica (Kingston)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/jamaica/Kingston.jpg" alt="">
</div>
</div>
<!--Fin  Kingston-->
<!--Ocho Ríos-->
<div class="aero">
    ...
    <div class="horarios">
        <div class="padre">
            ...
            <div class="left">
                <div class="left-img"><img src="../imagen/estadosUnidos/destino.png" alt=""></div>
                <div class="left-text"><p><b>DESTINO: </b> Jamaica (Ocho Ríos)</p></div>
            </div>
        </div>
        <!--Hora y fecha de los vuelos-->
        <div class="padre-1">
...
<div class="img">
<img src="../imagen/jamaica/Ocho Ríos.webp" alt="">
</div>
</div>
<!--Fin Ocho Ríos-->
    <!--pie de pagina web-->
