...
<body>
    ...
    if ($inc){
        ...
        <div class="row">
            ...
            <div class="col-lg-1  col-12 border border-black text-center p-1"><a class="btn btn-danger" onclick={eliminar()} role="button" id="link">Eliminar</a></div>            
            <!---->
        </div>
    </div>
            <?php
...
<script>
    function eliminar() {
        let x = confirm("¿Esta seguro que desea eliminar este Vuelo?");
        if (x) {
